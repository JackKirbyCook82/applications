...
def main(*args, symbols=[], webapi={}, delayers={}, period, parameters={}, **kwargs):
    ...
    with WebReader(delayer=delayers[Website.ALPACA]) as alpaca_source, WebReader(delayer=delayers[Website.ETRADE], service=etrade_service, authenticate=True) as etrade_source:
        ...
        etrade_pipeline = symbols_dequeuer + stocks_downloader + bar_downloader + expires_downloader + options_downloader
        etrade_pipeline = etrade_pipeline + technical_calculator + stock_pricing + option_pricing + appraisal_calculator + security_calculator + security_filter

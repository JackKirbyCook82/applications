...
def divestiture(*args, table, saving, parameters={}, **kwargs):
    divestiture_reader = ValuationReader(name="DivestitureReader", table=table, valuation=Variables.Valuations.ARBITRAGE)
...
def main(*args, logger, arguments, parameters, **kwargs):
    ...
    divestiture_parameters = dict(saving={holdings_file: "a"}, table=divestiture_table, criterion=criterion, functions=functions, parameters=parameters)

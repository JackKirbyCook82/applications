...
if __name__ == "__main__":
    ...
    sysAuthenticator = SimpleNamespace(**pd.read_csv(AUTHENTICATORS, sep=r"\s+", converters={"live": to_bool}).set_index(["website", "live"], inplace=False).loc[("etrade", False)].to_dict())

...
def main(*args, **kwargs):
    ...
    holdings_directory = Directory(name="HoldingDirectory", repository=PORTFOLIO, variable="holdings")
    exposure_directory = Directory(name="ArbitrageDirectory", repository=PORTFOLIO, variable="exposure")
    security_directory = Directory(name="ArbitrageDirectory", repository=PORTFOLIO, variable="security")

...
def exposure(*args, source, destination, current, parameters={}, **kwargs):
...
def main(*args, **kwargs):
    ...
    security_parameters = dict(source={exposure_file: "r", statistic_file: "r"}, destination={option_file: "w"}, functions=functions)
...
if __name__ == "__main__":
    ...
    main(current=Datetime(year=2024, month=6, day=17), parameters={"discount": 0.0, "fees": 0.0})
